...
describe('[Challenge] The rewarder', function () {
    ...
    it('Execution', async function () {
        ...
        const AttackRewarderFactory = await ethers.getContractFactory('AttackRewarder', player);
        await (await AttackRewarderFactory.deploy(rewarderPool.address, flashLoanPool.address, liquidityToken.address, rewardToken.address)).attack(TOKENS_IN_LENDER_POOL);
